...
class Lit_Model(pl.LightningModule):
    def __init__(
        ...
        self.loss_bce = smp.losses.SoftBCEWithLogitsLoss(pos_weight=torch.tensor(.75))  # pos_weight=torch.tensor(1), smooth_factor=0.1
    ...
    def configure_optimizers(self):
        ...
        optimizer = torch.optim.AdamW(filter(lambda p: p.requires_grad, model.parameters()), lr=self.cfg.learning_rate, weight_decay=self.cfg.weight_decay)
