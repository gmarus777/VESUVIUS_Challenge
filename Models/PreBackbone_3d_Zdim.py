...
class PreBackbone_3D_ZDIM(nn.Module):
    def __init__(self, out_channels = 3, z_dim= 24, emdedding_dims=[4], filter_sizes=[8, 16, 32,], batch_norm=False):
        ...
        self.batch_norm = torch.nn.BatchNorm3d(num_features=1, momentum=0.1, eps=1e-03)
        ...
        self.batch_norm1 = torch.nn.BatchNorm3d(
            num_features=filter_sizes[0]//2, eps=1e-03
        )
        ...
        self.batch_norm2 = torch.nn.BatchNorm3d(
            num_features=filter_sizes[1]//2, eps=1e-03
        )
